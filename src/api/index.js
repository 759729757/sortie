...
export const getIndexNews = params => { return axios.get(`${_base}/fetchIndexNews` ,{params:params}).then(res=>res.data); };
export const findNewsByName = params => { return axios.get(`${_base}/findNewsByName` ,{params:params}).then(res=>res.data); };
export const getNewsType = params => { return axios.get(`${_base}/getNewsType`, { params: params }); };
...
export const books = params => { return axios.get('' ,{params:params}).then(res=>res.data); };
